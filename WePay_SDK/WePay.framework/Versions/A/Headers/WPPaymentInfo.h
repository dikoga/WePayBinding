...
/**
 *  The payment method used, one of (kWPPaymentMethodApplePay, kWPPaymentMethodGoogleInstantBuy, kWPPaymentMethodManual, kWPPaymentMethodSwiper).
 */
@property (nonatomic, strong, readonly) id paymentMethod;

/**
 *  Additional info obtained by using the Swiper payment method.
 */
...
/**
 *  Additional info obtained by using the Apple Pay payment method.
 */
@property (nonatomic, strong, readonly) id applePayInfo;

/**
 *  Additional info obtained by using the Google Instant Buy payment method.
 */
@property (nonatomic, strong, readonly) id googleInstantBuyInfo;
...
/**
 *  Intializes a \ref WPPaymentInfo instance with Apple Pay info obtained from the user.
 *
 *  @param applePayInfo Apple Pay info obtained from the user.
 *
 *  @return A \ref WPPaymentInfo object initialized with Apple Pay info obtained from the user.
 */
- (instancetype) initWithApplePayInfo:(id)applePayInfo;

/**
 *  Intializes a \ref WPPaymentInfo instance with Google Instant Buy info obtained from the user.
 *
 *  @param googleInstantBuyInfo Google Instant Buy info obtained from the user.
 *
 *  @return A \ref WPPaymentInfo object initialized with Google Instant Buy info obtained from the user.
 */
